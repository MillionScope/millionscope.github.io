...
export const VersionFooter = ({ handleVersionChange, documents, currentVersionIndex }) => {
            ...
            mutate(
              ...
              }),
              {
                optimisticData: documents
                  ? [...documents.filter((document) => isAfter(new Date(document.createdAt), new Date(getDocumentTimestampByIndex(documents, currentVersionIndex))))]
                  : [],
              }
            )
          }}
