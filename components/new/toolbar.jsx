...
const Tool = ({ description, icon, selectedTool, setSelectedTool, isToolbarVisible, setIsToolbarVisible, isAnimating, append, onClick }) => {
...
const ReadingLevelSelector = ({ setSelectedTool, append, isAnimating }) => {
  ...
  const [hasUserSelectedLevel, setHasUserSelectedLevel] = useState(false)
    ...
    <div className="relative flex flex-col justify-end items-center">
      ...
      <TooltipProvider>
        <Tooltip open={!isAnimating}>
          ...
          <TooltipContent side="left" sideOffset={16} className="bg-foreground text-background text-sm rounded-2xl p-3 px-4">
            {LEVELS[currentLevel]}
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
...
export const Tools = ({ isToolbarVisible, selectedTool, setSelectedTool, append, isAnimating, setIsToolbarVisible, tools }) => {
...
const PureToolbar = ({ isToolbarVisible, setIsToolbarVisible, append, isLoading, stop, setMessages, artifactKind }) => {
